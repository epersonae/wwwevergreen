...
<form action="/search/home" class="search" method="get" role="search"><label for="q">Search</label> <input id="q" name="q" placeholder="Search" type="search"/><!-- --><button class="search-button"><img alt="Search" src="<?php echo($base_path . $directory) ?>/images/search-32.png"/></button> 
<ul class="element-list search-tools">
<li class="internal-users-alt"><a href="https://my.evergreen.edu"><img alt="User" height="10" src="<?php echo($base_path . $directory) ?>/images/user-32.png" width="10"/> my.evergreen.edu</a></li>
...
<div class="logo"><a href="http://evergreen.edu"><img alt="The Evergreen State College&#8212;Olympia, Washington" src="<?php echo($base_path . $directory) ?>/images/logo.png" srcset="<?php echo($base_path . $directory) ?>/images/evergreen-long-tree-oly.svg 1x, <?php echo($base_path . $directory) ?>/images/evergreen-long-tree-oly.svg 2x"/></a></div>
<div class="off-canvas"><label class="search-toggle" for="search-flag"><img alt="Search" src="<?php echo($base_path . $directory) ?>/images/search-w32.png"/></label> <label class="student-toggle" for="internal-users-flag"><img alt="Profile" src="<?php echo( $base_url . "/". path_to_theme()) ?>/images/user-w32.png"/></label></div>
</div>
