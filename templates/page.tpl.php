...
<li><a href="https://my.evergreen.edu"><img alt="User" height="10" src="<?php echo($theme_path) ?>/images/user-32.png" width="10"/> my.evergreen.edu</a></li>
...
<form action="/search/home" class="search" method="get" role="search"><label for="q">Search</label> <input id="q" name="q" placeholder="Search" type="search"/><!-- --><button class="search-button"><img alt="Search" src="<?php echo($theme_path) ?>/images/search-32.png"/></button> 
<ul class="element-list search-tools">
<li class="internal-users-alt"><a href="https://my.evergreen.edu"><img alt="User" height="10" src="<?php echo($theme_path) ?>/images/user-32.png" width="10"/> my.evergreen.edu</a></li>
...
<div class="logo"><a href="http://evergreen.edu"><img alt="The Evergreen State College&#8212;Olympia, Washington" src="<?php echo($theme_path) ?>/images/logo.png" srcset="<?php echo($theme_path) ?>/images/evergreen-long-tree-oly.svg 1x, <?php echo($theme_path) ?>/images/evergreen-long-tree-oly.svg 2x"/></a></div>
<div class="off-canvas"><label class="search-toggle" for="search-flag"><img alt="Search" src="<?php echo($theme_path) ?>/images/search-w32.png"/></label> <label class="student-toggle" for="internal-users-flag"><img alt="Profile" src="<?php echo($theme_path) ?>/images/user-w32.png"/></label></div>
</div>
...
<p class="footer-map"><a href="http://evergreen.edu/tour/home"><img alt="Map of Washington" src="<?php echo($theme_path) ?>/images/map-land-cover.jpg"/></a><br/>
...
<li><a href="http://facebook.com/TheEvergreenStateCollege" title="Facebook"><img alt="Facebook" class="lineup-icon" src="<?php echo($theme_path) ?>/images/icons/external/facebook32x32.png"/></a></li>
<li><a href="http://twitter.com/EvergreenStCol" title="Twitter"><img alt="Twitter" class="lineup-icon" src="<?php echo($theme_path) ?>/images/icons/external/twitter32x32.png"/></a></li>
<li><a href="http://youtube.com/user/evergreen" title="YouTube"><img alt="YouTube" class="lineup-icon" src="<?php echo($theme_path) ?>/images/icons/external/youtube32x32.png"/></a></li>
<li><a href="http://instagram.com/TheEvergreenStateCollege" title="Instagram"><img alt="Instagram" class="lineup-icon" src="<?php echo($theme_path) ?>/images/icons/external/instagram32x32.png"/></a></li>
<li><a href="http://www.linkedin.com/edu/school?id=19655" title="LinkedIn"><img alt="LinkedIn" class="lineup-icon" src="<?php echo($theme_path) ?>/images/icons/external/linkedin32x32.png"/></a></li>
</ul>
</li>
</ul>
</div>
